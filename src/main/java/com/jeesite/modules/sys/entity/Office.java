...
@Table(name="${_prefix}sys_office", alias="a", columns={
		...
		@Column(name="office_attachment", attrName="officeAttachment", 	label="附件"),
...
public class Office extends TreeEntity<Office> {
	...
	private String officeAttachment; // 附件
	private String officeAttachment__del;
	...
	public String getOfficeAttachment() {
		return officeAttachment;
	}

	public void setOfficeAttachment(String officeAttachment) {
		this.officeAttachment = officeAttachment;
	}

	public String getOfficeAttachment__del() {
		return officeAttachment__del;
	}

	public void setOfficeAttachment__del(String officeAttachment__del) {
		this.officeAttachment__del = officeAttachment__del;
	}
